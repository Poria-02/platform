...
// */
//@Slf4j
//@Service(PlatUserLoginService.SERVICE_ID + PlatLoginType.MA_USER_INNER)
//public class MaUserInnerLoginService implements PlatUserLoginService {
//
//	@Autowired
...
//
//		try{
//			R<LoginUserAccountVo> user = remoteCustomerService.loadUserByOpenId( token.getLoginModel().getUsername(),
...
//                new BCryptPasswordEncoder().encode("123456"),loginType,
//				true, true, true,
