...
package cn.poria.auth.endpoint;

import cn.hutool.core.date.DatePattern;
import cn.hutool.core.date.TemporalAccessorUtil;
import cn.hutool.core.map.MapUtil;
import cn.hutool.core.util.StrUtil;
import cn.poria.auth.support.plat.PlatAuthenticationFailureHandler;
import cn.poria.auth.utils.OAuth2EndpointUtils;
import cn.poria.auth.utils.OAuth2ErrorCodesExpand;
import cn.poria.auth.utils.OAuthClientException;
...
import cn.poria.upms.api.feign.RemoteClientDetailsService;
import cn.poria.upms.api.vo.TokenVo;
...
public class PlatTokenEndpoint {

    private final HttpMessageConverter<OAuth2AccessTokenResponse> accessTokenHttpResponseConverter = new OAuth2AccessTokenResponseHttpMessageConverter();
    private final AuthenticationFailureHandler authenticationFailureHandler = new PlatAuthenticationFailureHandler();
