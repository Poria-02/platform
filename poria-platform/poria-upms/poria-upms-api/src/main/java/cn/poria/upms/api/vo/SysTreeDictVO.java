...
public class SysTreeDictVO {
   ...
   public List<SysTreeDictItem> getTreeItems() {
   ...
   public void setTreeItems(final List<SysTreeDictItem> treeItems) {
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof SysTreeDictVO)) {
         return false;
      } else {
         SysTreeDictVO other = (SysTreeDictVO)o;
         if (!other.canEqual(this)) {
            ...
            Object this$treeItems = this.getTreeItems();
            Object other$treeItems = other.getTreeItems();
            if (this$treeItems == null) {
               if (other$treeItems != null) {
                  return false;
               }
            } else if (!this$treeItems.equals(other$treeItems)) {
               return false;
            }
   ...
   protected boolean canEqual(final Object other) {
      return other instanceof SysTreeDictVO;
   }
   ...
   public int hashCode() {
      ...
      Object $treeItems = this.getTreeItems();
      result = result * 59 + ($treeItems == null ? 43 : $treeItems.hashCode());
      return result;
   }

   public String toString() {
      String var10000 = this.getId();
      return "SysTreeDictVO(id=" + var10000 + ", code=" + this.getCode() + ", name=" + this.getName() + ", remark=" + this.getRemark() + ", type=" + this.getType() + ", isTree=" + this.getIsTree() + ", tenantId=" + this.getTenantId() + ", deptId=" + this.getDeptId() + ", isDelete=" + this.getIsDelete() + ", createBy=" + this.getCreateBy() + ", createTime=" + this.getCreateTime() + ", updateBy=" + this.getUpdateBy() + ", updateTime=" + this.getUpdateTime() + ", treeItems=" + this.getTreeItems() + ")";
   }
}
