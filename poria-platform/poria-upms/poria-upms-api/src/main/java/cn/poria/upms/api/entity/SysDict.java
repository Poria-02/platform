...
public class SysDict extends Model<SysDict> {
   ...
   public String toString() {
      ...
      return "SysDict(id=" + var10000 + ", type=" + this.getType() + ", description=" + this.getDescription() + ", createTime=" + this.getCreateTime() + ", updateTime=" + this.getUpdateTime() + ", system=" + this.getSystem() + ", remarks=" + this.getRemarks() + ", delFlag=" + this.getDelFlag() + ")";
   }

   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof SysDict)) {
         return false;
      } else {
