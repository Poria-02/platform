...
public class TreeDictItemVo implements Serializable {
   ...
   public List<TreeDictItemVo> getChilds() {
      return this.childs;
   }
   ...
   public void setChilds(final List<TreeDictItemVo> childs) {
      this.childs = childs;
   }
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof TreeDictItemVo)) {
         return false;
      } else {
         TreeDictItemVo other = (TreeDictItemVo)o;
   ...
   protected boolean canEqual(final Object other) {
      return other instanceof TreeDictItemVo;
   }
   ...
   public String toString() {
      ...
      return "TreeDictItemVo(id=" + var10000 + ", name=" + this.getName() + ", simpleName=" + this.getSimpleName() + ", remark=" + this.getRemark() + ", value=" + this.getValue() + ", ext1=" + this.getExt1() + ", pid=" + this.getPid() + ", sort=" + this.getSort() + ", childs=" + this.getChilds() + ", dictId=" + this.getDictId() + ")";
   }
}
