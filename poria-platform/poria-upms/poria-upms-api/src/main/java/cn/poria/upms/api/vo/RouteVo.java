...
public class RouteVo {
   ...
   public boolean equals(final Object o) {
      if (o == this) {
         return true;
      } else if (!(o instanceof RouteVo)) {
         return false;
      } else {
         RouteVo other = (RouteVo)o;
   ...
   public String toString() {
      ...
      return "RouteVo(id=" + var10000 + ", routeId=" + this.getRouteId() + ", routeName=" + this.getRouteName() + ", predicates=" + this.getPredicates() + ", filters=" + this.getFilters() + ", uri=" + this.getUri() + ", order=" + this.getOrder() + ", createTime=" + this.getCreateTime() + ", updateTime=" + this.getUpdateTime() + ", metadata=" + this.getMetadata() + ")";
   }
}
