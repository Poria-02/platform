...
const roles = ref([])
const columns = [{ prop: 'username', label: '用户名' }, { prop: 'phone', label: '手机号' }, { prop: 'deptName', label: '部门' }, { prop: 'lockFlag', label: '锁定状态' }, { prop: 'createTime', label: '创建时间', width: 180 }]
...
const fields = computed(() => [
  ...
  { prop: 'lockFlag', label: '锁定状态', type: 'select', default: '0', options: [{ label: '正常', value: '0' }, { label: '锁定', value: '9' }] }
])
