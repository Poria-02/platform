...
const fields = [{ prop: 'clientId', label: '客户端 ID', required: true, immutable: true }, { prop: 'clientSecret', label: '客户端密钥', type: 'password' }, { prop: 'scope', label: '授权范围' }, { prop: 'authorizedGrantTypes', label: '授权方式', type: 'select', multiple: true, joinWith: ',', dictionary: 'grant_types' }, { prop: 'accessTokenValidity', label: '令牌有效期', type: 'number' }, { prop: 'refreshTokenValidity', label: '刷新有效期', type: 'number' }]
